...
const Dashboard = () => {
    const { filteredClass, filter } = StateContext()
    ...
    return (
        <div className='w-full h-auto flex lg:bg-[#F6F6F7] lg:p-3 gap-3'>
            <div className='w-full lg:w-[50%] h-full flex-col'>
                <div className='w-full min-h-[85%] bg-white rounded-lg flex flex-col p-3'>
            ...
            <div className='hidden lg:flex lg:w-[50%] h-[85%] bg-white rounded-lg'>
                {/* Assignments */}
